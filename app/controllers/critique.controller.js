...
exports.update = (req, res) => {
  ...
  .then(num => {
    if (num == 1) {
      ...
      res.send({
        message: 'Cannot update critique with id=' + id + '. Maybe the critique was not found or req.body is empty!'
      });
    }
  })
  .catch(err => {
...
exports.delete = (req, res) => {
  ...
  .then(num => {
    if (num == 1) {
      ...
      res.send({
        message: 'Cannot delete critique with id=' + id + '. Maybe the critique was not found'
      })
    }
  })
  .catch((err) => {
