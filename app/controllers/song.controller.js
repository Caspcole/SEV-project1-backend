...
exports.update = (req, res) => {
  ...
  .then(num => {
    if (num == 1) {
      ...
      res.send({
        message: 'Cannot update song with id=' + id + '. Maybe the song was not found or req.body is empty!'
      });
    }
  })
  .catch(err => {
...
exports.delete = (req, res) => {
  ...
  .then(num => {
    if (num == 1) {
      ...
      res.send({
        message: 'Cannot delete song with id=' + id + '. Maybe the song was not found'
      })
    }
  })
  .catch((err) => {
