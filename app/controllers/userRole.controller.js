...
exports.update = (req, res) => {
  ...
  .then(num => {
    if (num == 1) {
      ...
      res.send({
        message: 'Cannot update userRole with id=' + id + '. Maybe the userRole was not found or req.body is empty!'
      });
    }
  })
  .catch(err => {
...
exports.delete = (req, res) => {
  ...
  .then(num => {
    if (num == 1) {
      ...
      res.send({
        message: 'Cannot delete userRole with id=' + id + '. Maybe the userRole was not found'
      })
    }
  })
  .catch((err) => {
